    ...
    <div className="web_body">
      ...
      <div className='list_movie'>
        ...
        <Container
          ...
          name={item.name}
          epi={item.episode}
          getDataMovie={() => setDataMovie(item)}
        />
        ))}
      </div>
    </div>
